...
import { Twitter, Linkedin, Instagram, YouTube, Spotify, Supabase, BuyMeaCoffee, Vercel, OutlineDragIndicator, PlusBold, RoundMinus } from '../components/Social';
import { Dock, DockIcon } from "@/components/magicui/dock";

// Import the Icons object from App.tsx or recreate it here
export const Icons = {
    ...
    notion: (props: React.HTMLAttributes<SVGElement>) => (
        <svg
            width="100"
            height="100"
            viewBox="0 0 100 100"
    ...
    googleDrive: (props: React.HTMLAttributes<SVGElement>) => (
    ...
    whatsapp: (props: React.HTMLAttributes<SVGElement>) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    return (
        <>
            <div className='w-full h-[100vh] px-20 py-10 '>
                <div className='w-full h-auto flex  flex-col   pb-15'>
                        ...
                        <div className='min-w-[40%] max-w-[50%]  w-auto h-full sticky top-10'>
                            <div className='flex flex-col gap-8' >
                                ...
                                <div className='flex flex-col gap-5 w-full ' >
                                    <p className='font-bold text-5xl ' contentEditable style={{ outline: 'none' }}>Yassin Atti</p>
                                    <textarea
                                        style={{ outline: "none" }}
                                        name=""
                            ...
                            <div className='flex justify-start relative' >
                                <div className="absolute left-[-25px] top-3/5 transform -translate-y-1/2 flex items-center gap-1">
                                    <PlusBold className="h-4 w-4 text-gray-400 cursor-pointer" />
                                </div>
                                <DockDemo />
                            </div>
                        </div>
                        <div className='w-full  h-full flex flex-col gap-15  pb-5' >
                            <div className='w-full   flex flex-col items-start gap-5' >
                                ...
                                <div className='p-2 relative' >
                                    <div className="absolute left-[-40px] top-1/2 transform -translate-y-1/2 flex items-center gap-1">
                                        <PlusBold className="h-4 w-4 text-gray-400 cursor-pointer" />
                                        <OutlineDragIndicator className="h-5 w-5 text-gray-400 cursor-grab" />

                                    </div>
                                    <p className='text-2xl font-medium' >My products</p>
                                </div>
                    ...
                    <div className='fixed  bottom-7 left-1/3 transform -translate-x-1/1 p-3 flex items-center justify-between w-[30%] border border-gray-300 rounded-2xl shadow-lg gap-5 bg-white z-50'>
                        <div className='flex items-center gap-3' >
                            <div>
                                <button className='text-sm bg-green-400 text-black w-[85px] h-[35px] rounded-xl font-medium cursor-pointer'>Share it</button>
                            </div>
                            <div className='flex items-center gap-1' >
                                

                                <button className='text-sm text-black w-[35px] h-[35px] flex items-center justify-center rounded-xl font-medium cursor-pointer hover:bg-gray-100'>
                        ...
                        <div className="relative pl-3 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-[80%] before:w-[2px] before:bg-gray-200 before:rounded-full">
                            <div className='flex items-center gap-1'>
                               

                                <button className='text-sm text-black w-[35px] h-[35px] flex items-center justify-center rounded-xl font-medium cursor-pointer hover:bg-gray-100' >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><rect width="18" height="12" x="3" y="4" rx="2" ry="2" /><line x1="2" x2="22" y1="20" y2="20" /></svg>
                                </button>
